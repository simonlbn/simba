...
.. image:: ../images/boards/esp32-devkitc-pinout.png
   :width: 50%
   :target: ../_images/esp32-devkitc-pinout.png

.. include:: extra/esp32_devkitc.rst
...
Read more about board specific functionality in the :doc:`ESP32-DevKitC
<../library-reference/boards/esp32_devkitc>` module documentation in the
Library Reference.
...
+==========================+===========+===========+
| minimal-configuration    |     91353 |      8636 |
+--------------------------+-----------+-----------+
| default-configuration    |    354389 |     83344 |
+--------------------------+-----------+-----------+
